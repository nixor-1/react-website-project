...
const Table = <T,>({
  ...
  const borderStyling = isEmbedded
    ? ""
    : "border-0 border-b-2 border-t border-color-primary rounded-none md:border md:border-color-primary md:rounded-rounding-primary md:border-width-secondary";
