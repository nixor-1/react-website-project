...
const HomePage = () => {
  ...
  const spacingStyles =
    "pb-0 border-b border-color-primary md:pb-6 md:border-t-0 md:border-b-0";

  return (
    <PageMarginsNew pageMarginsWidth="2" isScrollable={true}>
      <div
        className={`${spacingStyles} border-t border-b-2 border-color-primary`}
      >
        <TextBox
      ...
      <div className={`${spacingStyles} border-b-2 border-color-primary`}>
        <TextBox
